...
class MultiWozDataset(object):
    def __init__(self, args, split='train', shuffle=True):
        ...
        self.actions = json.load(open('Processed_data/multi-woz/dialogue_acts.json', 'r'))
        ...
        if args.lexical:
            cached_filename = 'Processed_data/cached_data_lexical_{}.pkl'.format(split)
        else:
            cached_filename = 'Processed_data/cached_data_delex_{}.pkl'.format(split)
