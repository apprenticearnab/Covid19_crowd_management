...
multiwoz_data = json.load(open('/content/simpletod/Processed_data/multi-woz/lex.json', 'r'))
save_dir = '/content/simpletod/Processed_data/simptod'
os.makedirs(save_dir, exist_ok=True)
f1_train = open('/content/simpletod/Processed_data/simptod/context_train.txt','w')
f1_val = open('/content/simpletod/Processed_data/simptod/context_val.txt','w')
f1_test = open('/content/simpletod/Processed_data/simptod/context_test.txt','w')
f2_train = open('/content/simpletod/Processed_data/simptod/belief_train.txt','w')
f2_val = open('/content/simpletod/Processed_data/simptod/belief_val.txt','w')
f2_test = open('/content/simpletod/Processed_data/simptod/belief_test.txt','w')
